...
* /projects/project-postdoc-2021.html
...
* examining large-scale errors in celestial reference frames;
* selecting suitable AGNs and optimizing the frame tie;
* understanding the relation between absolute source position and observing frequency.
...
1. <u>Liu N.</u>, Lambert S. B., Arias E. F., Liu J.-C., Zhu Z.
   [Evaluation of the ICRF stability from a position time series analysis](https://ui.adsabs.harvard.edu/abs/2022A%26A...659A..75L/).
   *Astronomy & Astrophysics*, 659, A75, 2022.

2. <u>Liu N.</u>, Lambert S. B., Charlot P., Zhu Z., Liu J.-C., Jiang N., Wan X.-S., Ding C.-Y.
   [Comparison of multifrequency positions of extragalactic sources from ICRF3 and *Gaia* EDR3](https://ui.adsabs.harvard.edu/abs/2021A%26A...652A..87L/).
   *Astronomy & Astrophysics*, 652, A87, 2021.
